# Generated by Django 3.1.5 on 2023-07-20 18:41
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('question_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='lessons.question')),
                ('incorrect_answer_options', models.ManyToManyField(help_text='Question should have three Incorrect Answer Options', related_name='question_this_is_incorrect_option_for', to='lessons.VocabWord')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('question_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='lessons.question')),
                ('correct_sentence', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='question_this_is_correct_answer_for', to='lessons.sentence')),
                ('incorrect_answer_options', models.ManyToManyField(help_text='Question should have three Incorrect Answer Options', related_name='question_this_is_incorrect_option_for', to='lessons.Sentence')),
            ],
            bases=('lessons.question',),
        ),
    ]
